...
public enum PointUtils {
	...
	public static Point add(Point base, Vector direction)
	{
		return Point.builder()
				.setX((int) (base.getX() + direction.getX()))
				.setY((int) (base.getY() + direction.getY()))
				.setZ((int) (base.getZ() + direction.getZ()))
				.build();
	}
	...
	{
		return Point.builder()
				.setX((int) (point.getX() * vector.getX()))
				.setY((int) (point.getY() * vector.getY()))
				.setZ((int) (point.getZ() * vector.getZ()))
				.build();
	}
